...
public class ResourceGatewayClient extends Interface_Client {
    ...
    /**
     * the uri of the resource service's __ resource gateway__ a default would be
     ...
     * @param id
     *            an identifier used as a parameter for the boolean action passed
     * @param handle
     *            a valid session handle
     ...
     * @param handle
     *            a valid session handle
     * @return an XML string describing the NonHumanResource id/name pairs, or an
     *         appropriate error message
     * @throws IOException
     *             if the service can't be reached
     */
     ...
     * @param handle
     *            a valid session handle
     * @return an XML string describing the UserPrivileges, or an appropriate error
     *         message
     * @throws IOException
     *             if the service can't be reached
     */
     ...
     * 
     * @param anyID
     *            the id of a Participant, Role, Capability, Position or OrgGroup
     * @param handle
     *            a valid session handle
     * @return the list of the ids of all participants who are members of the group
     *         object referenced; if anyID is the id of a single participant, then
     *         only that id is returned in the list
     * @throws IOException
     *             if the service can't be reached
     */
     ...
     * @param handle
     *            a current sessionhandle with admin privileges
     * @return if successful, the id of the newly added role; if not, an explanatory
     *         error message
     * @throws IOException
     *             if the service can't be reached
     */
    ...
    /**
     * Updates a Role record with the specified values. Note that besides roleID and
     * handle, all other parameters may be null, which will indicate that the
     * current value for that field is not to be updated (ie. the existing value is
     * maintained).
     * 
     * @param roleID
     *            the (existing) id of the Capability
    ...
    /**
     * Updates a Position record with the specified values. Note that besides posID
     * and handle, all other parameters may be null, which will indicate that the
     * current value for that field is not to be updated (ie. the existing value is
     * maintained).
     * 
     * @param posID
     ...
     * that the current value for that field is not to be updated (ie. the existing
     * value is maintained).
     * 
     * @param groupID
    ...
    /**
     * Removes the specified category from the set of NonHumanResource categories;
     * any sub-categories of the specified categories are also removed.
     * 
     * @param id
    ...
    /**
     * Sets the containing Role for a Role (i.e. the 'parent' Role the Role 'belongs
     * to')
     * 
     * @param roleID
     ...
     * @param containingGroupID
     *            the id of the containing or parent OrgGroup that encapsulates the
     *            'child' OrgGroup
     * @param handle
     *            a current sessionhandle with admin privileges
     * @return a message indicating success, or if not successful, an explanatory
     ...
     * @param containingPositionID
     *            the id of the containing or parent Position that encapsulates the
     *            'child' Position
     * @param handle
     *            a current sessionhandle with admin privileges
     * @return a message indicating success, or if not successful, an explanatory
    ...
    /**
     * Sets the containing OrgGroup for a Position (i.e. the OrgGroup the Position
     * 'belongs to')
     * 
     * @param positionID
    ...
    /**
     * Sets the user privileges of the specified participant individually via a 'bit
     * string'
     * 
     * @param participantID
     *            the (existing) id of the participant
     * @param bits
     *            an eight character string where each character corresponds to a
     *            privilege (see the alternate setParticipantPrivileges() method for
     *            the ordering). For each privilege, a character value of '1'
     *            indicates that the privilege is to be granted and a character of
     *            any other value indicates that the privilege is to be denied. The
     *            last character overrides all other privileges, so that a value of
     *            '1' in the last position grants all privileges, while any other
     *            value in the last position defers to the individual settings of
     *            each privilege.
     * @param handle
     *            a current sessionhandle with admin privileges
     * @return a message indicating success, or if not successful, an explanatory
    ...
    /**
     * Sets the user privileges of the specified participant on an 'all on' or 'all
     * off' basis
     * 
     * @param participantID
     *            the (existing) id of the participant
